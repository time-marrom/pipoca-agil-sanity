export default {
  ...
  type: 'document',
  title: 'Mentor',
  description: 'Conteúdos da página de inscrição de mentores',
  fields: [
    {
      name: 'title',
      type: 'string',
    ...
    },
    {
      ...
      type: 'array',
      title: 'Passos',
      description: 'Textos que guiarão o mentor no processo de inscrição.',
      of: [
        {
          type: 'object',
          fields: [
    ...
    },
    {
      ...
      description: 'Título do aviso para o mentor.',
    },
    {
      name: 'warning',
      type: 'string',
      title: 'Aviso',
      description: 'Texto de alerta para o mentor.',
    },
    {
      name: 'titleOfRules',
      type: 'string',
    ...
    },
    {
      ...
      type: 'array',
      title: 'Regras',
      description: 'Textos que descrevem as regras e pré-requisitos para ser mentor.',
      of: [{type: 'string'}],
    },
    {
